                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6 col-md-6 col-lg-6">
                            ...
                            {{Form::select('tipo',
                                ...
                                ['class' => 'form-control' , 'onChange' => 'selectColuna();']                               
                            )}}
                        ...
                        <div id="div_placa" class="form-group col-6 col-md-6 col-lg-6">
                            ...
                            {{Form::text('placa',((isset($data->veiculo) && sizeof($data->veiculo)) ? $data->veiculo[0]->placa : '')
                                ,['class' => 'form-control placa', 'onChange' => 'buscarPlaca()', 'placeholder' => 'Informe a Placa'])}}
                        </div>
                        ...
                        <div id="div_botao_placa" class="d-none form-group col-12 col-md-12 col-lg-12">
                            ...
                            <a href="{{ route('admin.veiculo.index') }}" class="btn btn-primary btn-lg d-flex align-self-end">
                        ...
                        <div id="div_botao_rg" class="d-none form-group col-12 col-md-12 col-lg-12">
                            <a href="{{ route('admin.pessoa.index') }}" class="btn btn-primary btn-lg d-flex align-self-end">
