            ...
            <div class="card">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group col-6 col-md-6 col-lg-6">
                            ...
                            {{Form::text('placa',$data['placa'],['class' => 'form-control', 'placeholder' => 'Informe a Placa'])}}
                        </div>
                        <div class="form-group col-6 col-md-6 col-lg-6">
                            {{Form::label('modelo', 'Modelo')}}
                            {{Form::text('modelo',$data['modelo'],['class' => 'form-control', 'placeholder' => 'Modelo'])}}
                        </div>
                        <div class="form-group col-6 col-md-6 col-lg-6">
                        ...
                        <div class="form-group col-6 col-md-6 col-lg-6">
                            ...
                            {{Form::text('observacao',$data['observacao'],['class' => 'form-control', 'placeholder' => 'Observação'])}}
                        </div>
                    </div>
                    <div class="row">
